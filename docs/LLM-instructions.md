...
- Follow markdownlint rules for all .md files (per
  [our markdown linting guide](./development-conventions/markdown/linting-guide.md))
...
- MANDATORY: If violations exist, fix them immediately - do not proceed
  with other tasks
